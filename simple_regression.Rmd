...
* The team with a very high residual compared to the others appears to be an
outlier. 
Anwer:  The residuals show a curved pattern.  
...
can you tell?
Answer: As runs move up, hits also goes up, the relationship is linear 
</div>
```{r pick-model}
# type your code for the Exercise here, and Knit
mlb11 %>% 
